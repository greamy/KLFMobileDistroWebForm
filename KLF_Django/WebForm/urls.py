...
urlpatterns = [
	...
	path('forgot-password/reset/', views.forgot_password_reset, name='forgotPasswordReset'),
	path('forgot-password/code/', views.forgot_password_code, name='forgotPasswordCode'),
